...
public class FileConvert extends JFrame {
    ...
    private void initializeComponents() {
        ...
        resizedImagesList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (index >= 0) {
                        File file = new File("converted_files",
                                resizedImagesModel.getElementAt(index).getDescription());
                        openFile(file);
                    }
                }
            }
        ...
        JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, resizedImagesScrollPane,
                convertedDocsScrollPane);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(FileConvert::new);
    }
}