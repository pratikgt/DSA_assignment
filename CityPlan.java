...
public class CityPlan {
    ...
    public static List<int[]> findValidModification(int n, int[][] roads, int source, int destination, int targetTime) {
        ...
        if (initialDistance == targetTime) {
            // If the initial path already matches the target time, return the roads as they
            // are
...
// So executing the above codes for the given conditions in the question I
// observed the following as output..
