...
// On gui selecting start city and end city we can get the shortest route among
// six
// selected cities
// if there is no node between the cities means I have assumed that there exists
// no path
